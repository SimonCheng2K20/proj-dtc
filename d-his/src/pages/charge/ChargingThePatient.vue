    ...
    <div class="grid grid-cols-4 gap-2">
      ...
      <q-card class="bg-grey-2" flat>
        <q-card-section class="flex h-full flex-col">
          <div class="text-xl font-bold">慢箋</div>
          <my-input-group class="grid gap-1">
            <my-input-wrapper label="慢箋單號">
              <q-input v-bind="QInputProps" :model-value="null" readonly></q-input>
            </my-input-wrapper>
            <my-input-wrapper label="執行數">
              <q-input v-bind="QInputProps" :model-value="null" readonly></q-input>
            </my-input-wrapper>
          </my-input-group>
...
import PayTheCheckEditItem from './components/PayTheCheckEditItem.vue'
import DrugDetailInfoItem from './components/DrugDetailInfoItem.vue'
