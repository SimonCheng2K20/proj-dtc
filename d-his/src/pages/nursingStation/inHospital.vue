...
import { getIpdRecordItem } from 'api'
...
const tab = ref()
const tabs = [
  { label: '入院資料', to: { name: 'NursingStation-Clerk-InHospital-InHospitalData' } },
  { label: '身分變更', to: { name: 'NursingStation-Clerk-InHospital-IdentityChange' } },
  { label: '轉床/互轉', to: { name: 'NursingStation-Clerk-InHospital-BedChange' } },
  { label: '伙食', to: { name: 'NursingStation-Clerk-InHospital-Food' } },
  { label: '出院準備', to: { name: null } },
]
