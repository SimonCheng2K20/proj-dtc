    ...
    <my-dialog-content :header="editHeader" width="1280px" @close="onDialogCancel" :loading="getDataLoading">
      ...
      <my-input-group class="grid grid-cols-2 gap-2">
        ...
        <my-input-wrapper label="生日">
          <my-date-input v-model="editItem.Patient.Person.BirthDate" readonly></my-date-input>
        </my-input-wrapper>
        ...
        <my-input-wrapper label="連絡電話"
          ><q-input v-bind="QInputProps" v-model="editItem.Patient.Person.Phone"></q-input
        ></my-input-wrapper>
        ...
        <my-input-wrapper label="病患身分">
          <q-input v-bind="QInputProps" v-model="editItem.IdentityName" readonly></q-input>
        </my-input-wrapper>
        <my-input-wrapper label="床位號">
          <q-input v-bind="QInputProps" v-model="editItem.BedName" readonly></q-input>
        </my-input-wrapper>
        <my-input-wrapper label="優先等級">
          <q-input v-bind="QInputProps" v-model="editItem.優先等級" readonly></q-input>
        </my-input-wrapper>
        <my-input-wrapper label="床位類別">
          <q-input v-bind="QInputProps" v-model="editItem.BedTypeName" readonly></q-input>
        </my-input-wrapper>
        <my-input-wrapper label="健保類別">
          <q-input v-bind="QInputProps" v-model="editItem.健保類別" readonly></q-input>
        </my-input-wrapper>
        <my-input-wrapper label="床位等級">
          <q-input v-bind="QInputProps" v-model="editItem.BadReserveGrade" readonly></q-input>
        </my-input-wrapper>
        <my-input-wrapper label="預約日期時間">
          <my-date-input v-model="editItem.IpdPreDate" readonly></my-date-input>
        </my-input-wrapper>
...
import { getIpdRecordItem, postIpdRecordItem, putIpdRecordItem, deleteIpdRecordItem } from 'api'
