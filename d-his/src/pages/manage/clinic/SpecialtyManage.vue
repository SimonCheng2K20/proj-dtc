<template>
  <q-page>
    <my-title title="科別管理" no-fixed></my-title>
    <div class="p-2">
...
import EditItem from './components/SpecialtyEditItem.vue'
...
const columns = [
  ...
  { name: 'ParentNo', label: '部門代碼', field: 'ParentNo', align: 'left' },
  { name: 'ParentName', label: '部門名稱', field: 'ParentName', align: 'left' },
  { name: 'No', label: '科別代碼', field: 'No', align: 'left' },
  { name: 'Name', label: '科別名稱', field: 'Name', align: 'left' },
  { name: 'DeclaredDepartmentNo', label: '申報科別代碼', field: 'DeclaredDepartmentNo', align: 'left' },
  { name: 'DeclaredDepartmentName', label: '申報科別名稱', field: 'DeclaredDepartmentName', align: 'left' },
