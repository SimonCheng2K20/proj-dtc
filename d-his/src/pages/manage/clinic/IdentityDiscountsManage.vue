...
const columns = [
  ...
  { name: 'Code', label: '門診折扣身分代碼', field: 'Code', align: 'left' },
  { name: 'Name', label: '門診折扣身分名稱', field: 'Name', align: 'left' },
