...
const columns = [
  ...
  { name: 'No', label: '就醫科別代碼', field: 'No', align: 'left' },
  { name: 'Text', label: '就醫科別名稱', field: 'Text', align: 'left' },
]
...
const filter = computed(() => {
  ...
  return str ? str + ` and Category eq 'Department'` : `Category eq 'Department'`
})
