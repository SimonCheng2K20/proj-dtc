...
const columns = [
  ...
  { name: 'No', label: '健保床位性質代碼', field: 'No', align: 'left' },
  { name: 'Text', label: '健保床位性質名稱', field: 'Text', align: 'left' },
]
...
const filter = computed(() => {
  ...
  return str ? str + ` and Category eq 'HealthBed'` : `Category eq 'HealthBed'`
})
