...
const columns = [
  ...
  { name: 'No', label: '入院許可優先等級代碼', field: 'No', align: 'left' },
  { name: 'Text', label: '入院許可優先等級名稱', field: 'Text', align: 'left' },
]
...
const filter = computed(() => {
  ...
  return str ? str + ` and Category eq 'PriorityLevel'` : `Category eq 'PriorityLevel'`
})
