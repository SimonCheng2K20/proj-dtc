...
const columns = [
  ...
  { name: 'No', label: '床位類別代碼', field: 'No', align: 'left' },
  { name: 'Text', label: '床位類別名稱', field: 'Text', align: 'left' },
]
...
const filter = computed(() => {
  ...
  return str ? str + ` and Category eq 'BedType'` : `Category eq 'BedType'`
})
