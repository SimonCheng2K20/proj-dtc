...
const columns = [
  ...
  { name: 'No', label: '住院病患轉歸代碼', field: 'No', align: 'left' },
  { name: 'Text', label: '住院病患轉歸名稱', field: 'Text', align: 'left' },
]
...
const filter = computed(() => {
  ...
  return str ? str + ` and Category eq 'inpatientOutcome'` : `Category eq 'inpatientOutcome'`
})
