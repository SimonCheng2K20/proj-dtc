...
const columns = [
  ...
  { name: 'No', label: '床位狀態代碼', field: 'No', align: 'left' },
  { name: 'Text', label: '床位狀態名稱', field: 'Text', align: 'left' },
]
...
const filter = computed(() => {
  ...
  return str ? str + ` and Category eq 'BedStatus'` : `Category eq 'BedStatus'`
})
