...
const columns = [
  ...
  { name: 'No', label: '床位等級代碼', field: 'No', align: 'left' },
  { name: 'Text', label: '床位等級名稱', field: 'Text', align: 'left' },
]
...
const filter = computed(() => {
  ...
  return str ? str + ` and Category eq 'BedLevel'` : `Category eq 'BedLevel'`
})
