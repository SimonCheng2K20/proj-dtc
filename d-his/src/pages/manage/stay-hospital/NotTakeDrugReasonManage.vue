...
import EditItem from './components/NotTakeDrugReasonEditItem.vue'
...
const columns = [
  ...
  { name: 'No', label: '未用藥原因代碼', field: 'No', align: 'left' },
  { name: 'Text', label: '未用藥原因名稱', field: 'Text', align: 'left' },
]
...
const filter = computed(() => {
  ...
  return str ? str + ` and Category eq 'reason'` : `Category eq 'reason'`
})
