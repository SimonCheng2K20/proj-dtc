  ...
  <section class="dtc-main-section px-3">
    <section class="search-block">
      ...
      <div class="p-2 search-section">
        ...
        <div class="p-inputgroup">
          <span class="p-inputgroup-addon">離島衛生所(室)</span>
          <Dropdown
      ...
      <div class="p-2 search-section">
        <div class="p-inputgroup">
          <span class="p-inputgroup-addon">離島醫院(在地醫院)</span>
          <Dropdown
        ...
        <div class="p-inputgroup">
          <span class="p-inputgroup-addon">本島醫院(遠距合作醫院)</span>
          <Dropdown
    ...
    >
      ...
      <div
        ...
        v-if="nowType != 1"
      >
        <span class="p-inputgroup-addon special-addon" style="width: 188px"
          >此網絡群管理單位</span
        >
...
export default defineComponent({
  ...
  setup() {
    ...
    const headers = ref([
      ...
      { name: "離島衛生所(室)", key: "", sortDesc: null },
      {
        name: "本島醫院(遠距合作醫院)",
        key: "",
        sortDesc: null,
      },
      { name: "離島醫院(在地醫院)", key: "", sortDesc: null },
    ...
    async function getData() {
      try {
        ...
        if (bQs) {
          qs = appendEqualNumFilter("Type", qs, 2);
        } else {
          qs = equalNumFilter("Type", qs, 2);
        }
