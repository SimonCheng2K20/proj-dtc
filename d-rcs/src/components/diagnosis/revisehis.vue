  ...
  <div class="main-section">
    ...
    <div class="main-content overflow-auto custom-scroll-bar">
      <div class="content-left">
        ...
        <div class="table-block mb-1 area-block">
          <h3 style="text-align: left !important">特註</h3>
          <Textareaprime
            class="textarea-content custom-scroll-bar"
            maxlength="2000"
            v-model="items2"
        ...
        <div class="table-block mb-1">
          <h3 style="text-align: left !important">診斷</h3>
          <tablecomponet
            :headers="headers3"
            :items="items3"
        ...
        <div class="table-block mb-1">
          <h3 style="text-align: left !important">處置</h3>
          <tablecomponet
            :headers="headers4"
            :items="items4"
        ...
        <div class="table-block mb-1 custom-scroll-bar">
          <h3 style="text-align: left !important; min-width: 900px">檢驗</h3>
          <tablecomponet
            :headers="headers6"
            :items="items6"
...
import revisehismodal from "./revisehismodal.vue";
export default {
  components: { tablecomponet, revisehismodal },
  props: {
    itemData: {
      type: Object,
      required: true,
  ...
  setup(props, { emit }) {
    ...
    const modalHis = ref(null);

    const showModal = () => {
      // console.log("modalHis", );
      modalHis.value.hisModal = true;
    };
    ...
    const setData = (item, type) => {
      ...
      items6.value = allArr.reduce((acc, cur) => [...acc, ...cur.DiagnosticReports], []);
    };
