  ...
  <div class="main-section">
    ...
    <div class="main-content">
      <div class="content-left overflow-auto custom-scroll-bar">
        ...
        <div class="table-block mb-1 custom-scroll-bar">
          <h3 style="text-align: left !important; min-width: 1200px">
            牙科處置及手術作業
          </h3>
          <tablecomponet
            :headers="headers4"
            :items="items4"
            columnstyle="grid-template-columns:  repeat(10, 1fr);"
            minwidth="1200"
          ></tablecomponet>
        </div>
        <div class="table-block mb-1 custom-scroll-bar">
        ...
        <div class="table-block mb-1 custom-scroll-bar">
          <h3 style="text-align: left !important; min-width: 2700px">檢驗檢查結果</h3>
          <tablecomponet
            :headers="headers6"
            :items="items6"
        ...
        <div class="table-block mb-1 custom-scroll-bar">
          ...
          <tablecomponet
            :headers="headers7"
            :items="items7"
            columnstyle="grid-template-columns: repeat(6, 1fr);"
            minwidth="720"
          ></tablecomponet>
        </div>
        <div class="table-block mb-1 custom-scroll-bar">
        ...
        <div class="table-block mb-1 custom-scroll-bar">
          ...
          <tablecomponet
            :headers="headers9"
            :items="items9"
            columnstyle="grid-template-columns: repeat(12, 1fr);"
            minwidth="1440"
          ></tablecomponet>
        </div>
      </div>
...
import revisecloudmodal from "./revisecloudmodal.vue";
export default {
  components: { tablecomponet, revisecloudmodal },
  props: {
    itemData: {
      type: Object,
      required: true,
  ...
  setup(props, { emit }) {
    const modalCloud = ref(null);

    const showModal = () => {
      // console.log("modalCloud", );
      modalCloud.value.cloudModal = true;
    };
    const headers1 = ref([
      ...
      switch (type) {
        case "cloud1":
          ...
          if (item == "All Data") {
            ...
            items1.value = props.itemData?.cloud1.filter((s) =>
              `${s.timedata}`.includes(item)
            );
          }
          break;
        case "cloud2":
          ...
          if (item == "All Data") {
            ...
            items2.value = props.itemData?.cloud2.filter((s) =>
              `${s.timedata}`.includes(item)
            );
          }
          break;
        case "cloud3":
          ...
          if (item == "All Data") {
            ...
            items3.value = props.itemData?.cloud3items3.filter((s) =>
              `${s.timedata}`.includes(item)
            );
          }
          break;
        case "cloud4":
          ...
          if (item == "All Data") {
            ...
            items4.value = props.itemData?.cloud4.filter((s) =>
              `${s.timedata}`.includes(item)
            );
          }
          break;
        case "cloud5":
          ...
          if (item == "All Data") {
            ...
            items5.value = props.itemData?.cloud5.filter((s) =>
              `${s.timedata}`.includes(item)
            );
          }
          break;
        case "cloud6":
          ...
          if (item == "All Data") {
            ...
            items6.value = props.itemData?.cloud6.filter((s) =>
              `${s.timedata}`.includes(item)
            );
          }
          break;
        case "cloud7":
          ...
          if (item == "All Data") {
            ...
            items7.value = props.itemData?.cloud7.filter((s) =>
              `${s.timedata}`.includes(item)
            );
          }
          break;
        case "cloud8":
          ...
          if (item == "All Data") {
            ...
            items8.value = props.itemData?.cloud8.filter((s) =>
              `${s.timedata}`.includes(item)
            );
          }
          break;
        case "cloud9":
          ...
          if (item == "All Data") {
            ...
            items9.value = props.itemData?.cloud9.filter((s) =>
              `${s.timedata}`.includes(item)
            );
          }
          break;
