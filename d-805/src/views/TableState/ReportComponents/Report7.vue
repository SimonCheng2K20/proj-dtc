...
import { getHrrMessageList, getDoctorReportCount } from '@/assets/service/dataManager.js'
import { reportAmount } from '@/views/TableState/ReportComponents/ReportStat.js'
  ...
  methods: {
    ...
    async GetData() {
      ...
      try {
        ...
        const res = await getDoctorReportCount(params.join('&'))
        res.Items.forEach((item) => {
          ;['IssueTime', 'StudyTime'].forEach((key) => {
            if (item[key] != null) {
