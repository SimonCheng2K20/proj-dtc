...
export const defaultHotKeyArr = [
  ...
  { hotkey: 'F12', default: 'F12', method: 'callView', title: 'CALL LAB' },
  {
    hotkey: 'F3',
    default: 'F3',
...
export const tabTags = (id) => {
  return [
    ...
    id == '21' && JSON.parse(process.env.VUE_APP_FI0304_IS_NEED_TAB_FI0304_pendingAppr)
      ? {
          label: '待審核',
...
export const FI0304HotkeyArr = (() => {
  switch (process.env.VUE_APP_VERSION_NO) {
    case '805':
      return [
        { hotkey: [], method: 'callPacs', title: '呼叫PACS' },
        {
          hotkey: [],
          method: 'WinMass4Objective',
        ...
        {
          hotkey: [],
          method: 'viewAbnormalReport',
          title: '異常通報',
        },
        {
          hotkey: [],
          method: 'WinMass4Phrase',
          title: '片語維護',
        },
        {
          hotkey: [],
        ...
        { hotkey: [],
          method: '$refs.reportBtns.onCallLabClick',
          title: 'LIS'
        },
        {
          hotkey: [],
          method: 'FailImageReport',
          title: '不良片',
        },
        {
          hotkey: [],
          method: 'OpenExaminationFor805Dialog',
          title: '原鄉篩檢',
        },
        {
          hotkey: [],
          method: '$refs.reportBtns.onPrintClick',
          title: '報告列印',
        },
        {
          hotkey: [],
          method: '$refs.reportBtns.onTempSaveClick',
          title: '暫存報告',
        },
        {
          hotkey: [],
          method: '$refs.reportBtns.onSaveClick',
          title: '正式報告',
        },
        {
          hotkey: [],
          method: 'insertObjectContent',
          title: '插入臨床申請檢查註記',
        },
        // {
        //   hotkey: [],
        //   method: 'viewReNewReportTemp',
        //   title: '放棄撰打',
        // },
      ]
    default:
      return [
        ...
        { hotkey: [], method: 'callView', title: 'CALL LAB' },
        {
          hotkey: [],
          method: '$refs.reportBtns.onPrintClick',
          title: '報告列印',
