    ...
    <tbody>
      <tr>
        ...
        <td colspan="3">
          ...
          <input ref="isMri" id="isMri" name="isMri" class="e-field e-input" type="text" style="display: none;" />
          ...
          <input id="CheckItemNames" class="e-field e-input" type="text" name="CheckItemNames" style="display: none;" v-model="data.CheckItemNames" />
        </td>
      </tr>
      <tr v-show="showDirects || showDirect">
        <td ref="CheckItemLabel" class="e-textlabel" v-show="showDirects">指定可檢查項目<br />(空則不限制)</td>
        <td class="e-textlabel" v-show="showDirect">指定檢查項目</td>
        <td>
          <ejs-multiselect
            ref="CheckItemIds"
            id="CheckItemIds"
...
export default {
  data() {
    return {
      ...
      RepeatRules: [
        { text: "", value: null },
        { text: "每日重複此時段，排至此月底", value: "DayRepeat" },
        { text: "每週重複此時段，排至此月底", value: "WeekRepeat" }
      ],
      freeDays: [
        { label: "不解鎖", value: 0 },
        { label: "1天", value: 1 },
  ...
  mounted: function() {
    ...
    this.showDirects = this.data.Type == 2 || this.data.Type == 3;
