<template>
  <section class="body mt-1">
    ...
    <div class="my-form">
      <b-input-group prepend="Carotid artery disease" class="pl-3">
        <b-form-radio-group class="px-3 py-2" v-model="chf" :options="answers"></b-form-radio-group>
      </b-input-group>
      ...
      <b-input-group prepend="GI bleeding">
        <b-form-radio-group class="px-3 py-2" v-model="chf" :options="answers"></b-form-radio-group>
      </b-input-group>
      <b-input-group prepend="Bleeding from other site" style="grid-column:1/-1">
        <b-textarea class="detail" style="height:40px;"></b-textarea>
      </b-input-group>
    ...
    <header class="step-header-grid mt-2">
      <div>Device</div>
