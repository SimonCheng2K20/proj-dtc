<template>
  <section class="body mt-2">
    <div class="sec1">
      <header>Atrial Tachycardia</header>
      ...
      <b-input-group prepend="Ablation site" style="margin-top:5px; margin-bottom:5px;">
        <b-input></b-input>
      </b-input-group>
    </div>
    <div class="dtc-input">
...
const types = ["Incessant", "inducible", "Paroxysmal"];
const focals = ["RS", "RI", "LS", "LI", "SVC"];
